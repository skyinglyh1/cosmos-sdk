...
func (msg MsgSyncGenesisParam) ValidateBasic() error {
	...
	if len(msg.GenesisHeader) == 0 {
		return sdkerrors.Wrap(sdkerrors.ErrInvalidAddress, "missing GenesisHeader bytes")
	}
	return nil
}
...
func (msg MsgSyncHeadersParam) ValidateBasic() error {
	...
	if len(msg.Headers) == 0 {
		return sdkerrors.Wrap(sdkerrors.ErrInvalidAddress, "missing BlockHeaders bytes")
	}
	return nil
}
